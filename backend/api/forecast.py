...
# 页面设置
st.set_page_config(page_title="LSTM 径流预测系统", layout="wide")
...
# 模型加载函数
def load_model(hidden_size1, hidden_size2, dropout):
            ...
            if not all(column in df.columns for column in required_columns):
                ...
                if st.button("🚀 开始预测"):
                    ...
                    try:
                        ...
                        model = load_model(hidden_size1, hidden_size2, dropout)
                        if model is None:
                            st.stop()
